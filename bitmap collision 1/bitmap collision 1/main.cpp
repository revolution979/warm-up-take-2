...
int main()
{
	...
	while (!doexit)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if ((key[0] && player_y >= 0) &&
				!(player_x > 64 && player_x <302 && player_y <204 && player_y>198))
			if ((key[0] && player_y >= 0) &&
					!(player_x > 64 && player_x <302 && player_y <204 && player_y>198))
			...
			if ((key[1] && player_y <= 480 - 32) &&
				!(player_x > 64 && player_x <302 && player_y <74 && player_y>66)) 
{
				player_y += 4.0;
			}
			...
			if ((key[2] && player_x >= 0) &&
				!(player_x > 290 && player_x <302 && player_y >70 && player_y<200))
			...
			if ((key[3] && player_x <= 640 - 32) &&
				!(player_x > 68 && player_x <78 && player_y >70 && player_y<200)) {
				player_x += 4.0;
			}
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			//wall 1
			al_draw_filled_rectangle(100, 400, 300, 300, al_map_rgb(200, 100, 0));

			al_draw_filled_rectangle(300, 200, 500, 300, al_map_rgb(0, 100, 0));

			al_draw_filled_rectangle(100, 100, 300, 200, al_map_rgb(200, 0, 0));
